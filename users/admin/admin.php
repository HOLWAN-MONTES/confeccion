                ...
                <form class="form-edi" id="form-edi" method="POST" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="terceralinea2">
                        <div id="grupo__clave_edi">
                            <label for="">CONTRASEÑA</label>    
                            <input class="input2 clave" type="password" name="contra_edi" id="contra_edi" placeholder="CONTRASEÑA" autocomplete="off" required>
   ...
   <!----------------------- SUB FORMULARIOS USUARIO-------------- ---------------------- -->
    ...
    <div class="todosLosusuarios" id="todosLosusuarios">
        ...
        <div class="containergeneralff" id="conte-user">
            <?php
                $sql_user = "SELECT DOCUMENTO,NOMBRE,APELLIDO,tipo_usuario.NOM_TIP_USU as cargo, FECHA_NACIMIENTO,CORREO,tipo_documento.NOM_TIP_DOCU as tipo_docu,FOTO from usuario, tipo_usuario,tipo_documento where usuario.ID_TIP_USU=tipo_usuario.ID_TIP_USU and usuario.ID_TIP_DOCU=tipo_documento.ID_TIP_DOCU and usuario.DOCUMENTO != 0";
    ...
    <div class="lateral">
        ...
        <div class="menu caja2">
            <ul class="menu2">
                ...
                <li class="reportes" id="reportes"><a class="reportes" href="../../reportes/reporte_general.php">REPORTES<i class="icono derecha fas fa-chevron-down"></i></a>
                    <ul>
                        <li id="repMaquinaria" class="uno repMaquinaria"><a class="uno" href="../../reportes/reportes_maquinaria.php">REPORTES DE MAQUINARIA</a></li>
                        <li id="repMaterialText" class="uno repMateralT"><a class="uno" href="../../reportes/reportes_mat_tex.php">REPORTES DE MATERIAL TEXTIL</a></li>
                        <li id="repInsumo" class="uno repInsumos"><a class="uno" href="../../reportes/reportes_insumos.php">REPORTES DE INSUMOS</a></li>
                    </ul>
                </li>
            </ul>
        </div>
